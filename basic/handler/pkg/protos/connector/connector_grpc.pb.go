...
func (c *connectorClient) Write(ctx context.Context, in *WriteRequest, opts ...grpc.CallOption) (*BasicResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *connectorClient) Close(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*BasicResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BasicResponse)
...
type ConnectorServer interface {
	...
	Write(context.Context, *WriteRequest) (*BasicResponse, error)
	Close(context.Context, *Empty) (*BasicResponse, error)
...
func (UnimplementedConnectorServer) Write(context.Context, *WriteRequest) (*BasicResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Write not implemented")
}
func (UnimplementedConnectorServer) Close(context.Context, *Empty) (*BasicResponse, error) {
...
var Connector_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/protos/connector/connector.proto",
}
